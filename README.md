...
* 重要说明:从14.4以下升级 AirportItlwm有两个分支参考：https://github.com/OpenIntelWireless/itlwm/releases
需要先替换到旧版本的14.0（AirportItlwm_v2.3.0_stable_Sonoma14.0.kext） 升级到14.4后再替换回14.4（AirportItlwm_v2.3.0_stable_Sonoma14.4.kext）；每次修改完请重置nvram。
...
* --260324： OC升级至1.0.7，无痛更新至14.8.4；
* --251215： 修复3.5耳机音频驱动问题；
* --251211： OC升级至1.0.6，无痛更新至14.8.2；
* --250917： 无痛更新至14.8；
* --250825： 无痛更新至14.7.8；
