...
* OC1.0.2-EFI-NUC8-intel-wifi-BT-CardReader-Sonoma：包含自带读卡器、intel wifi和蓝牙驱动，适用于未做任何改动，使用自带读卡器、wifi和蓝牙的机型。

* OC1.0.2-EFI-NUC8-intel-wifi-BT-CardReader-Sonoma-14.4：包含自带读卡器、intel wifi和蓝牙驱动，适用于14.4开始未做任何改动，使用自带读卡器、wifi和蓝牙的机型。
